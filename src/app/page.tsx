          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="card p-6 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_16px_40px_-20px_rgba(0,0,0,0.2)]">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className="text-[15px] font-semibold text-zinc-900">Senior Python AI Engineer</h3>
                  <p className="mt-0.5 text-sm text-zinc-600">Example Company</p>
                </div>
                <ScoreBadge score={92} />
              </div>
              <div className="mt-3 flex flex-wrap gap-x-4 text-[13px] text-zinc-500"><span>Remote — India</span><span className="font-medium text-zinc-700">₹25–35 LPA</span><span>Full-time</span></div>
              ...
              <ul className="mt-2 space-y-1.5 text-[13px] text-zinc-700">
                {["Python experience", "AI/RAG experience", "4+ years experience", "Remote preference"].map((t) => (
              ...
              <ul className="mt-2 text-[13px] text-zinc-600"><li className="flex gap-2"><Warn className="mt-0.5 h-3.5 w-3.5 text-amber-500" />Requires AWS experience</li></ul>
